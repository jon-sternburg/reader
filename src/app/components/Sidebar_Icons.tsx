  ...
  return (
    <div className={styles.sidebar_icons}>
      <button
        ...
        type={"button"}
        className={styles.toc_icon}
        onClick={() => props.set_sidebar("toc")}
      >
        <FaListOl className={styles.toc} />
      </button>
      <button
        aria-label={"Settings"}
        type={"button"}
      ...
      <button
        ...
        type={"button"}
        className={
          props.annotations_length > 0
            ? styles.annotations_icon
            : styles.annotations_icon_disabled
        }
        onClick={() =>
          props.annotations_length > 0 ? props.set_sidebar("annotations") : {}
        }
      >
        <FaStickyNote />
      </button>
      <button
        ...
        type={"button"}
        className={
          props.spark_length > 0
            ? styles.annotations_icon
            : styles.annotations_icon_disabled
        }
        onClick={() =>
          props.spark_length > 0 ? props.set_sidebar("sparknotes") : {}
        }
      >
        <BsAsterisk />
      </button>
      <button
        ...
        type={"button"}
        className={styles.settings_icon}
        onMouseEnter={() => set_tooltip(true)}
        onMouseLeave={() => set_tooltip(false)}
      >
        <BsFillInfoCircleFill className={styles.settings} />
      </button>

      {props.results_length > 0 && (
        <button
          aria-label={"Search text"}
          type={"button"}
          className={styles.indicator_icon}
          onClick={() => props.set_sidebar("search")}
        >
          <FaSearch className={styles.indicator} />
        </button>
      )}
