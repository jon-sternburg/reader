...
export default function Sidebar_Icons_Fixed(props: SIF_Props) {
  return (
    <div className={styles.sidebar_icons_fixed_col}>
      {props.sidebar == null ? (
        <Sidebar_Icons
          spark_length={props.spark_length}
          results_length={props.results_length}
          annotations_length={props.annotations_length}
        ...
        <Fragment>
          <button
            ...
            type={"button"}
            className={styles.close_sidebar_icon}
            onClick={() =>
          ...
          <Fragment>
            {props.sidebar == "search" && (
              <button
                aria-label={"Clear search and search results"}
                type={"button"}
