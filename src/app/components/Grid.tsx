...
export default function Grid(props: G_Props): JSX.Element {
  ...
  return (
    <div className={styles.frame}>
      {props.w >= 1000 && (
        <Top_Bar_Homepage email={props.email} logged_in={props.logged_in} />
      )}
      ...
      <section className={styles.hero_wrap}>
        <div className={styles.hero_top}>
          ...
          <h4>
            Full annotation, highlight, SparkNotes, and text search support
          </h4>
        </div>
        {props.w <= 1000 && (
          <div
            className={styles.view_all_books}
