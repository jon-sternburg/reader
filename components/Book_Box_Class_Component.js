...
set_sidebar = (val) => {
  ...
  if (this.state.results && this.state.results.length > 0 && this.props.w < 1000) {

this.setState({sidebar: 'search'}) 

  } else { 
  this.state.sidebar == val ? this.setState({sidebar: null}) : this.setState({sidebar: val}) 
  }
